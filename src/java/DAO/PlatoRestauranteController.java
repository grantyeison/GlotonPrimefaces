...
public class PlatoRestauranteController implements Serializable {
    ...
    private PlatoRestaurante current;
    ...
    public PlatoRestauranteController() {
    }
    ...
    private PlatoRestauranteFacade getFacade() {
        return ejbFacade;
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PlatoRestauranteDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public PlatoRestaurante getPlatoRestaurante(java.lang.Integer id) {
